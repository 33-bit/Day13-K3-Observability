...
- Commit SHA Checkpoint 3: `8f51b030dd61b4497e522c0bf34b83d3cb9fca7a`
...
|---|---|---|---|
| Hoàng Danh Thái — 2A202601527 | Checkpoint 3: chạy challenge chính thức, điều tra Metrics → Traces → Logs, xác định root cause và đề xuất fix/phòng ngừa | [Commit CP3](https://github.com/33-bit/Day13-K3-Observability/commit/8f51b030dd61b4497e522c0bf34b83d3cb9fca7a) | Phân biệt latency trong trace với thời gian client và nhận diện blocking work trong async endpoint |
